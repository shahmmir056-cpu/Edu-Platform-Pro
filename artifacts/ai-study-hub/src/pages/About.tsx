    ...
    <div className="pb-0 overflow-x-hidden">
      ...
      <section className="px-4 sm:px-6 -mt-8 md:-mt-12 relative z-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { src: "/images/kid-tablet.jpg", alt: "Student exploring interactive learning on a tablet", span: "md:col-span-2 md:row-span-2", height: "h-64 md:h-full" },
            { src: "/images/lab-colorful.jpg", alt: "Colorful science lab equipment for virtual experiments", span: "", height: "h-64" },
            { src: "/images/robot-tutor-3.jpg", alt: "Logic circuits and AI-powered learning", span: "", height: "h-64" },
          ].map((img, i) => (
            <motion.div
              key={img.src}
      ...
      <section className="px-6 pb-24 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
          <motion.div
            ...
            style={{ border: "2px solid #2D2D2D", boxShadow: "inset 0 0 0 1px rgba(255,159,76,0.1), inset 0 0 20px rgba(255,159,76,0.03), 0 4px 16px rgba(0,0,0,0.04)" }}
          >
            <img src="/images/robot-tutor-banner.jpg" alt="AI-powered tutor helping a student" className="w-full h-80 object-cover hover:scale-105 transition-transform duration-700" />
          ...
          <motion.div
            ...
            style={{ border: "2px solid #2D2D2D", boxShadow: "inset 0 0 0 1px rgba(255,159,76,0.1), inset 0 0 20px rgba(255,159,76,0.03), 0 4px 16px rgba(0,0,0,0.04)" }}
          >
            <img src="/images/lab-research.jpg" alt="Students conducting research experiments" className="w-full h-80 object-cover hover:scale-105 transition-transform duration-700" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/15 to-transparent pointer-events-none" />
            <div className="absolute bottom-4 left-4 right-4">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold" style={{ background: "rgba(255,255,255,0.8)", border: "2px solid #2D2D2D", color: "#FF9F4C", backdropFilter: "blur(8px)" }}>
      ...
      <section className="px-6 pb-24 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <motion.div
            ...
            style={{ border: "2px solid #2D2D2D", boxShadow: "inset 0 0 0 1px rgba(255,159,76,0.1), inset 0 0 20px rgba(255,159,76,0.03), 0 4px 16px rgba(0,0,0,0.04)" }}
          >
            <img src="/images/robot-tutor-3.jpg" alt="AI Debate Mentor — interactive voice-powered debate practice" className="w-full h-80 md:h-96 object-cover hover:scale-105 transition-transform duration-700" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/15 to-transparent pointer-events-none" />
